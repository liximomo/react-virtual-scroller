...
var _createScheduler = require('../utlis/createScheduler');
...
var _findNewSlice = require('../utlis/findNewSlice');

var _findNewSlice2 = _interopRequireDefault(_findNewSlice);

var _Position = require('../modules/Position');
...
function collectRect(list, heights, defaultHeight) {
  ...
  list.forEach(function (item) {
    ...
    rects[id] = new _Rectangle2.default({
      top: top,
      height: height
    });
...
var Updater = function (_React$PureComponent) {
  ...
  function Updater(props) {
    ...
    _this._getRectangles = (0, _recomputed2.default)(_this, function (props) {
      return props.list;
    }, function (_, __, obj) {
      return obj._heights;
    }, function (props) {
    ...
    _this._getSlice = (0, _recomputed2.default)(_this, function (props) {
      return props.list;
    }, function (_, state) {
    ...
    _this._scheduleUpdate = (0, _createScheduler2.default)(_this._update, window.requestAnimationFrame);
    _this._handleScroll = (0, _lodash2.default)(_this._scheduleUpdate, 100, { trailing: true });
    return _this;
  }
  ...
  _createClass(Updater, [{
    ...
    value: function _getRelativeViewportRect() {
      if (!this._listRef) {
        return new _Rectangle2.default({ top: 0, height: 0 });
      }
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (prevList !== nextList) {
        var slice = (0, _findNewSlice2.default)(prevList, nextList, prevState.sliceStart, prevState.sliceEnd) || this._getDefaultSlice(nextList);
